...
<head>
    ...
    <meta content="Muh Safrilla" name="author">
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#"
                        ...
                        <img src="{{ Auth::user()->logo ? asset('storage/' . Auth::user()->logo) : asset('niceadmin/img/logo.png') }}"
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="{{ route('dashboard.show') }}" <i
                                class="bi bi-gear"></i>
